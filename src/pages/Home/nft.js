...
const Nft = ({type, bid_ends, favourites, title, network, price, usd, unit, creator_avatar, creator_name, onOpen, toggle, isFavourite}) => {
    return(
        <S.NftContainer onClick={onOpen}>
            <S.NftImageContainer>
                ...
                <S.Favourites onClick={(event) => {
                    event.stopPropagation();
                    toggle();
                }}>
                    {
                        isFavourite ?
                            <S.LoveFillIcon size={16}/>
                            : <S.LoveIcon size={16}/>
                    }
